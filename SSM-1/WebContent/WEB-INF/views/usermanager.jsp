...
<script>
	...
	//点击删除，修改，增加的图标，触发的函数，若信息为填写完整，则提示信息为填完。表单不提交
              ...
              <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" >
                      ...
                      <a class="navbar-brand" href="${pageContext.request.contextPath}/userController/backhead2"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;欢迎来到人事管理系统</a>
                </div>
...
<div class="modal fade" id="exampleModa9" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
    <form action="${pageContext.request.contextPath}/userController/updateAndselectAll" >
        <div role="tabpanel" class="tab-pane" id="profile4">
            <div class="modal-body" style="text-align:center;">
                <table class="table table-bordered " style="font-size:20px;">
                    ...
                    <tr>
                      <td>userid</td>
                      <td id="userid"><input type="text" name="id"/></td>
                	</tr>
                    <tr>
                      <td>username</td>
                      <td id="username"><input type="text" name="username"/></td>
                    </tr>
                    <tr>
                      <td>password</td>
                      <td id="password"><input type="text" name="password"/></td>
                    </tr>
                </table>
             </div>
...
<div class="modal fade" id="exampleModa11" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
    	<form action="${pageContext.request.contextPath}/userController/insertAndselectAll" >
        <div role="tabpanel" class="tab-pane" id="profile6">
            <div class="modal-body" style="text-align:center;">
             ...
             <!--模态框底部按钮-->
            <div class="modal-footer">
              <button type="button" class="btn btn-default" data-dismiss="moda1">Close</button>
               <input type="submit" class="btn btn-primary"  value="Submit"/>
            </div>
        </div>
        </form>
...
<div class="modal fade" id="exampleModa10" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
    <form action="${pageContext.request.contextPath}/userController/deleteAndselectAll">
    ...
    <div class="container-filued">
          ...
          <div class=" col-xs-8 col-md-9" style="margin-top:20px;">
                    <h1 class="page-header"><i class="fa fa-cog fa-spin"></i>&nbsp;&nbsp;<small>欢迎使用人事后台管理系统--->用户管理&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="demo"></span></small></h1>
                     
                     <div id="content">
                     <div class="container">
                     		<div class="row" style="margin-bottom:20px;">
								<div class="col-xs-4 col-xs-offset-3 ">
	                     		<form action="${pageContext.request.contextPath}/userController/selectoneAndselectAll" method="post">
                     		...
                     		<div class="row">
	                     		<div class="col-xs-10">
	                     			  <table class="table table-bordered table-hover" id="mytable">
	                     			  	<tr>
						                    <td  class="active">userid</td><td  class="success">username</td><td  class="info">password</td><td class="warning">删除</td><td class="warning">修改</td><td class="warning">增加</td>
						                </tr>
						                <c:forEach items="${keyus7 }" var="b">
							    			<tr><td  class="active">${b.id }</td>
							    			<td class="success">${b.username }</td>
							    			<td class="info">${b.password }</td>
							    			<td class="warning"><a data-toggle="modal" data-target="#exampleModa10" data-whatever="@getbootstrap"><span class="glyphicon glyphicon-trash col-xs-offset-5" aria-hidden="true"></span></a></td>
							    			<td class="warning"><a data-toggle="modal" data-target="#exampleModa9" data-whatever="@getbootstrap"><span class="glyphicon glyphicon-pencil col-xs-offset-5" aria-hidden="true"></span></a></td>
							    			<td class="warning"><a data-toggle="modal" data-target="#exampleModa11" data-whatever="@getbootstrap"><span class="glyphicon glyphicon-plus col-xs-offset-5" aria-hidden="true"></span></a></td>
							    			</tr>
							    		</c:forEach>
