              ...
              <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" >
                      ...
                      <a class="navbar-brand" href="${pageContext.request.contextPath}/jobController/backhead2"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;欢迎来到人事管理系统</a>
                </div>
...
<div class="modal fade" id="exampleModa9" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
    <form action="${pageContext.request.contextPath}/jobController/updateAndselectAll">
        <div role="tabpanel" class="tab-pane" id="profile4">
            <div class="modal-body" style="text-align:center;">
                <table class="table table-bordered " style="font-size:20px;">
                    ...
                    <tr>
                      <td>jobname</td>
                      <td id="jobname"><input type="text" name="jobname"/></td>
                    </tr>
...
<div class="modal fade" id="exampleModa11" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
    	<form action="${pageContext.request.contextPath}/jobController/insertAndselectAll">
...
<div class="modal fade" id="exampleModa10" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
    <form action="${pageContext.request.contextPath}/jobController/deleteAndselectAll">
                     ...
                     <div class="container">
                     		<div class="row" style="margin-bottom:20px;">
								<div class="col-xs-4 col-xs-offset-3 ">
	                     		<form action="${pageContext.request.contextPath}/jobController/selectoneAndselectAll" method="post">
